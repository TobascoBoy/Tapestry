...
// StickerView is kept as a SwiftUI View only for use if needed standalone.
// The real rendering happens in StickerUIView + StickerCoordinator,
// which are created directly by CanvasUIView.
...
final class StickerCoordinator: NSObject, UIGestureRecognizerDelegate {
    ...
    @objc func handlePan(_ gr: UIPanGestureRecognizer) {
        ...
        case .began:
            isGesturing = true
            onGestureStart?()
            panStartPosition = CGPoint(x: view.center.x, y: view.center.y)
